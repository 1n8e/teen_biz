...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildStats() {
    return Container(
      ...
      child: Row(
        children: [
          _statItem('1 200+', 'Пользователей', Icons.people),
          _divider(),
          _statItem('3 400+', 'Заказов', Icons.assignment),
          _divider(),
          _statItem('4.9', 'Рейтинг', Icons.star),
          _divider(),
  ...
  Widget _buildReviews() {
    final reviews = [
      ...
      },
      {
        'name': 'Дамир К., 18 лет',
        'text':
            'Веду Instagram для трёх бизнесов. За 2 месяца вышел на стабильный доход. Платформа огонь!',
        'stars': 5,
      },
      {
        'name': 'Айгерим Н., 16 лет',
        'text':
            'Монтирую видео для блогеров. Первый заказ получила в день регистрации. Эскроу — это супер!',
        'stars': 5,
      },
      {
        'name': 'Арман Б., 17 лет',
        'text':
            'Рисую иллюстрации и делаю стикеры. Уже 15 заказов за 3 месяца. Лучшая площадка для подростков!',
        'stars': 5,
      },
      {
        'name': 'Нурай А., 16 лет',
        'text':
            'Преподаю английский младшим школьникам. Родители учеников находят меня через TeenBiz.',
        'stars': 4,
      },
      {
        'name': 'Карина Л., 18 лет',
        'text':
            'Пишу тексты и посты для соцсетей. Удобно совмещать с учёбой — сама выбираю заказы.',
        'stars': 5,
      },
      {
        'name': 'Тимур Е., 17 лет',
        'text':
            'Собираю мебель и помогаю с мелким ремонтом. За месяц заработал на новый телефон!',
        'stars': 5,
      },
    ];
